...
export interface ApiFaqsFaqs extends Struct.SingleTypeSchema {
  collectionName: 'faqs_plural';
  info: {
    displayName: 'FAQs';
    pluralName: 'faqs-plural';
    singularName: 'faqs';
  };
  options: {
  ...
  attributes: {
    ...
    CTA: Schema.Attribute.Component<'cta.cta', false> &
      Schema.Attribute.Required;
    FAQItem: Schema.Attribute.Component<'faq-item.faq-item', true> &
      Schema.Attribute.Required;
...
export interface ApiGetInvolvedSubmissionGetInvolvedSubmission
  extends Struct.CollectionTypeSchema {
  collectionName: 'get_involved_submissions';
  info: {
    displayName: 'Get Involved Submission';
    pluralName: 'get-involved-submissions';
    singularName: 'get-involved-submission';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGetInvolvedGetInvolved extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Hero: Schema.Attribute.Media<'images' | 'files' | 'videos'> &
      Schema.Attribute.Required;
    IntroParagraph: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    SharedMeta: Schema.Attribute.Component<'basic.shared-meta', false>;
    StatusDescription: Schema.Attribute.Component<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WaysTheLoopWillTransformToronto: Schema.Attribute.Component<
      'home.carousel',
      true
    >;
  };
...
export interface ApiHubsHubs extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: ' Hubs and Neighbourhoods';
    pluralName: 'hubs-plural';
    singularName: 'hubs';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    Hero: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    HubItem: Schema.Attribute.Component<'hub-item.hub-item', true> &
      Schema.Attribute.Required;
...
export interface ApiMapsMaps extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Loop Trail Maps';
    pluralName: 'maps-plural';
    singularName: 'maps';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    IntroTitle: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::maps.maps'> &
      Schema.Attribute.Private;
    MapContainer: Schema.Attribute.Component<
