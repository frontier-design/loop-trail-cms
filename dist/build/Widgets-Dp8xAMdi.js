import{aS as j,j as t,aT as o,aU as w,aV as r,aW as C,b as T,a as L,aX as M,aY as W,f as l,aZ as v,a_ as S,a$ as I,b0 as $,b1 as D,b2 as A,b3 as K,b4 as N,b5 as m,ao as G}from"./strapi-dwicZU6L.js";import{W as u}from"./WidgetHelpers-DwrwSFGt.js";import{g as E,a as R}from"./users-DLc-PG84.js";const z=l(r)`
  font-size: 2.4rem;
`,X=()=>{const e=j("User",s=>s.user),n=E(e),c=R(e);return t.jsxs(o,{direction:"column",gap:3,height:"100%",justifyContent:"center",children:[t.jsx(w.Item,{delayMs:0,fallback:c}),n&&t.jsx(z,{fontWeight:"bold",textTransform:"none",textAlign:"center",children:n}),e?.email&&t.jsx(r,{variant:"omega",textColor:"neutral600",children:e?.email}),e?.roles?.length&&t.jsx(o,{marginTop:2,gap:1,wrap:"wrap",children:e?.roles?.map(s=>t.jsx(C,{children:s.name},s.id))})]})},P=l(m)`
  display: grid;
